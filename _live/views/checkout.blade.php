                                ...
                                @if($item)
                                    <div class="cart-item-single">
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-4 pr-0">
                                                        <div class="image-holder bg-white rounded-md shadow-sm border border-gray-200 text-center p-3">
                                                            <img src="images/{{request()->post()['PickedProductImageUrl'][$count]}}" alt="apple" class="w-14 h-14 object-contain">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <p class="mb-2 font-medium text-semibold text-gray-800">{{request()->post()['PickedProductName'][$count]}} -
                                            ...
                                            <div class="col-sm-4">
                                                <p class="m-0 font-medium text-right">&euro; <span class="amount">{{request()->post()['PickedProductUnitPrice'][$count]}}</span> </p>
                                            </div>

                                        </div>

                                        <input type="hidden" name="ProductName[]" value="{{request()->post()['PickedProductName'][$count]}}">
                                        <input type="hidden" name="ProductQuantity[]" value="{{request()->post()['PickedProductQuantity'][$count]}}">
                                        <input type="hidden" name="ProductUnitPrice[]" value="{{request()->post()['PickedProductUnitPrice'][$count]}}">
                                        <hr>
                                    </div>
                                    @php
                                    $items++;
