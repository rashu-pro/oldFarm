                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="dashboard-item border-2 border-solid border-blue-800 rounded-md">
                                            ...
                                            <h2 class="text-blue-800">Animal</h2>
                                        </div>
                                                ...
                                                <div class="dashboard-box rounded-md bg-white border border-gray-200">
                                                    <div class="dashboard-box-head pt-3 pb-2 px-2">
                                                        <select name="pick-item"
                                                            ...
                                                            <option value="chicken" data-name="Chicken - Autumn" data-image-name="chicken.png" data-unitprice="150">Chicken</option>
                                                            <option value="pork" data-name="Pork - winter" data-image-name="pork.png" data-unitprice="650">Pork</option>
                                                            <option value="lamb" data-name="Lamb - winter" data-image-name="lamb.png" data-unitprice="800">Lamb</option>
                                                        </select>
                                                    </div>
